    ...
    public class MainActivity : Activity
    {
        ...
        private void calcular(){
			...
			;if(string.IsNullOrWhiteSpace(precio.Text)){
                total.Text = "Error, no se ha introducido ningún valor";
            }else{
				try
				{
                    ...
                    total.Text = string.Format("El precio total a pagar es de {0}. Precio sin propina de {1} con una propina de {2}%.  ", resultado, auxPrecio.ToString(), auxPropina.ToString());
